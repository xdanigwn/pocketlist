...
// import { Router } from 'react-router-dom'
 ...
 function AccDetailPage(props) {
    ...
    useEffect (() => {
        const refreshDetail = () => {
            fetchPage(`https://admin-pocketlist.herokuapp.com/api/v1/authcheckaccountdtl/${match.params.id_account}`, "accountDetailPage");
        };
    ...
    const handlerDelete = async (e) => {    
        // e.preventDefault();
        props.fetchPage(`https://admin-pocketlist.herokuapp.com/api/v1/authcheckdeltrans/${e.currentTarget.getAttribute("data-id")}`, "DeleteTrans");
        props.fetchPage(`https://admin-pocketlist.herokuapp.com/api/v1/authcheckaccountdtl/${match.params.id_account}`, "accountDetailPage"); props.fetchPage(`https://admin-pocketlist.herokuapp.com/api/v1/authcheckaccountdtl/${match.params.id_account}`, "accountDetailPage");
    }
